    ...
    <div className="min-h-screen bg-white text-black print:bg-white">
      ...
      <div className="max-w-4xl mx-auto p-8 bg-white">
        ...
        <header className="text-center mb-8 border-b-2 border-gray-300 pb-6">
          ...
          <h2 className="text-xl text-gray-600 mb-4">Quality Lead Engineer</h2>
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            Quality Lead Engineer at Macquarie Group with over 17 years of experience in the technology industry. 
          ...
          <div className="space-y-6">
            <div>
              <div className="flex justify-between items-start mb-2">
                <div>
                  <h4 className="text-lg font-semibold text-gray-900">Quality Lead Engineer</h4>
